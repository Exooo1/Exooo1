...
<div id="header" align="center" background-color="red" display="flex">
  ...
  <div>
    ...
    <div>
      <h5>Frameworks:</h5>
      <ul>
         <li><p weight="900">React(Redux/Redux-Saga/Redux-Toolkit)<img width="30px" height="30px" src="https://media.tproger.ru/uploads/2020/12/react-roadmap-2021-cover-icon-original.png"/><img width="30px" height="30px" src="https://miro.medium.com/max/800/1*ZxmcaOzul181U6BT5z-Ipw.png"/></p></li>
